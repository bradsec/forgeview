...
const HELP_SECTIONS: { title: string; body: string }[] = [
  ...
  { title: 'Decimate and remesh', body: 'Both operations accept up to 5,000,000 input triangles. Decimate reduces toward an approximate triangle target; topology constraints can prevent reaching it. Uniform voxel remesh rebuilds a closed mesh on a grid. Repair open surfaces first. Output is stepped; subcell details may disappear. Neither guarantees topology preservation. Both support cancellation and undo.' },
